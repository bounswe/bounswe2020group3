...
private const val TAG = "ManageInvitesPresenter"

class ManageInvitesPresenter @Inject constructor(private var model: InviteContract.Model) : BasePresenter<ManageInvitesContract.View>(), ManageInvitesContract.Presenter {
    ...
    override fun setView(view: ManageInvitesContract.View) {
        this.view =view
    ...
    override fun bind(view: ManageInvitesContract.View) {
        projectId = view.projectId
        subscribeAuthToken()
        view.writeLogMessage("i",TAG,"presenter set the view, projectID : $projectId")
        super.bind(view)
                ...
                val getInvitesObservable = model.getInvited(projectId).subscribe(
                    { invitelist ->
                        ...
                        for (user in userlist){
                            ...
                            if (user.profile.isNotEmpty() and invited) {
