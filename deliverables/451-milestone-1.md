...
| Emirhan Yasin Cetin  | Edited the profile page code, so that editing will made user friendly <br/> Page routing settings <br/> Coding the profile page editing page and the functionalities <br/> Web security and using chrome for development settings |
